...
20.1.3 is the cleanup and security-foundation release. It intentionally keeps the existing My Bills features and local data format while reducing repository baggage and hardening the Android wrapper.

## Android identity and updates

- Application ID: `com.mybills.app`
- Permanent release signing alias: `mybills`
- Current version: `20.1.3` (`versionCode 148`)
...
- Service-worker, README, upload notes, and build metadata are aligned to 20.1.3.
...
## Android 16 / Play Store foundation in 20.1.3
...
## JavaScript cleanup phase 1 — 20.1.3
...
## JavaScript cleanup phase 2 — 20.1.3
...
## Accessibility / popup mobility — 20.1.3
